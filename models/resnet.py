...
# freeze conv
class MedResNet1(nn.Module):
    def __init__(self, block=BasicBlock, blocks_num=None, num_classes=2):
        super(MedResNet1, self).__init__()

        if blocks_num is None:
            blocks_num = [2, 2, 2, 2]

        self.model = ResNet(block, blocks_num)
