...
def infer(image_path, ckpt_path, device, save_dir='figures/classifier_torch/'):
    ...
    model = create_cnn_model('resnet18-sam', pretrained=False).to(device)
    ...
    plt.text(0, 1, "Prediction: " + str(label), color=(1, 0, 0), fontsize=12, weight='bold')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-path', type=str, required=False, default='imgs/pneumonia_img2.png',
